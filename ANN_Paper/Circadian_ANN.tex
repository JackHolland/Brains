...
\State \textbf{partition} $\mathcal{D}=\mathcal{D}_1\cup\mathcal{D}_2\cup\dots\cup\mathcal{D}_N$
\State \textbf{for } $i=1,2,\dots,N$
\State \hspace{.25cm} $\textbf{W}\gets \text{Train}(\mathcal{D\backslash\mathcal{D}_i}, \textbf{W}, numEpochs)$
\State \textbf{return W}\\
