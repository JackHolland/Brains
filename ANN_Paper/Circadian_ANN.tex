...
\begin{figure}[!ht]
  \centering
  \subfloat{\includegraphics[width=.2\textwidth]{Circadian.png}}\quad
  \subfloat{\includegraphics[width=.2\textwidth]{Non-Circadian.png}}\\
  \subfloat{\includegraphics[width=.2\textwidth]{Unclassified.png}}\quad
  \subfloat{\includegraphics[width=.2\textwidth]{PvsQ.png}}
